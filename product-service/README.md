...
บริการ Rust `axum` ที่กำหนดขอบเขตตามแนว Onion Architecture — จัดการข้อมูลสินค้า (CRUD) ที่เส้นทาง `/products` (มี middleware JWT) โดย schema อยู่ที่ `migrations/001_create_products.sql`
